...
# قائمة متنوعة (زدنا العدد لضمان عدم التكرار)
content_list = [
    ...
    {"t": "الْبُخْلُ عَارٌ، وَالْجُبْنُ مَنْقَصَةٌ.", "s": "نهج البلاغة"},
    {"t": "مَنْ صَارَعَ الْحَقَّ صَرَعَهُ.", "s": "أمير المؤمنين (ع)"},
    {"t": "اللهم صل على محمد وآل محمد وعجل فرجهم.", "s": "أذكار"},
    {"t": "سبحان الله والحمد لله ولا إله إلا الله والله أكبر.", "s": "الباقيات الصالحات"},
...
def send_random_post():
    try:
        ...
        # لاحظ هنا غيرنا كلمة "المصدر" إلى "المرجع" للتمييز
        msg = f"✨ {item['t']}\n\n📖 المرجع: {item['s']}\n\n🌿 صدقة جارية لروح المرحوم كاظم صالح خليفة"
        bot.send_message(CHAT_ID, msg)
        print("Success: Version 2 Sent")
